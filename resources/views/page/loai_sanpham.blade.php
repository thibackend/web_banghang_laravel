		...
		<div class="container">
			...
			<div class="pull-right">
				<div class="beta-breadcrumb font-large">
					<a href="{{url('/page')}}">Home</a> / <span>Loại Sản phẩm</span>
				</div>
			</div>
                                ...
                                <div class="col-sm-4">
                                    <div class="single-item">
                                        ...
                                        <div class="single-item-caption">
                                            ...
                                            <a class="beta-btn primary" href="chitietsanpham/{{$sp->id}}">Details <i class="fa fa-chevron-right"></i></a>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    @endif
                                        ...
                                        <div class="single-item-caption">
                                            ...
                                            <a class="beta-btn primary" href="chitietsanpham/{{$spk->id}}">Details <i class="fa fa-chevron-right"></i></a>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
                                </div>
