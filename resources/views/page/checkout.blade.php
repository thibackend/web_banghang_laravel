						...
						            <div class="your-order-body">
							              <ul class="payment_methods methods">
								                <li class="payment_method_bacs">
									...
									                  <div class="payment_box payment_method_bacs"style="display: block;"> Make your payment directly into our bank account.
																														   Please use your Order ID as the payment reference.
																														   Your order won’t be shipped until the funds have cleared in our account. </div>
									            </li>
								...
								                <li class="payment_method_vnpay">
									...
									            </li>
												<!-- Thêm mã HTML cho MOMO payment method -->
												<li class="payment_method_momo">
													<!-- <input id="payment_method_momo" type="radio" class="input-radio" name="payment_method" value="momo" data-order_button_text="Proceed to MoMo"> -->
													<label for="payment_method_momo">MOMO</label>
													<div class="payment_box payment_method_momo" style="display: none;">Pay via MoMo; you can pay with your credit card if you don’t have a MoMo account</div>
												</li>
